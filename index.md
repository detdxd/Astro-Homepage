...
**A**: 一般来说在本科阶段天文专业需要上物理专业所有的核心课程（包括几门[普通物理](https://book.douban.com/subject/36227939/)和四门[“四大力学”](https://book.douban.com/subject/1536321/)），另外再加上几门天文专业的基础课。其实有些学校本科天文招生是通过“物理学类”招生的。在研究生阶段物理和天文的不同方向课程都有所不同的，课表在有天文专业的学校的相关院系的主页上可以找到。   

**Q**: 天体物理涉及的物理主要有哪些 ?  
**A**: 天体的演化涉及的其实都是多物理（multi-physics）过程，目前的天文观测也已经步入多信使（multi-messenger，包括电磁波、引力波、中微子和宇宙线等）时代。另外，宇宙中的主导成分暗能量和暗物质是我们目前还无法理解的，天体环境往往还具有极端性（如极端的时空跨度和能量爆发），这些都有可能涉及未知的新物理。在具体的天体物理课题中常遇到的基本物理过程主要涉及引力与相对论、天体辐射机制、天体流体动力学等，其中对于做观测而言辐射是最重要的。如果研究宇宙线、早期宇宙学、致密星等，粒子物理与核物理也将变得十分重要。  
