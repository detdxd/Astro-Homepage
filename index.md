...
**A**: 这个和研究的方向和具体课题有关，但大致来说做理论（包括数值模拟）方向对理论基础要求会高一些。但即使对做理论方向而言，很多东西也是用到时候才学，而不必提前打过多基础，一个最小的理论基础集合就是普通物理+四大力学（基础部分）+天体物理导论+ 一门天体物理过程（如流体或广相）。另外，很多课内容也许很多，但其中基础和典型应用其实并不多，而这两部分才是最重要的，其他的除了应对考试完全可以等到用到时再说。  
