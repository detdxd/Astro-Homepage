...
**Q**: 天体物理中有哪些基本的物理过程 ?  
**A**: 原则上研究宇宙即使了解所有现有物理也不够，具体在天体物理科研中常遇到的基本物理过程主要涉及引力（包括牛顿引力和广义相对论）、辐射（包括辐射转移、原子分子辐射和运动带电粒子辐射等）、流体和等离子体物理等，其中对于做观测而言辐射是最重要的。如果研究宇宙线、早期宇宙学、致密星等，粒子物理与核物理过程也将变得十分重要。  
